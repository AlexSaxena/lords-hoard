    ...
    <section className="bg-white dark:bg-gray-900">
      <div className="min-h-screen grid lg:grid-cols-12">
        <section className="relative flex h-32 items-end bg-gray-900 lg:col-span-5 lg:h-full xl:col-span-6">
          <img
            alt="login-banner"
            src="https://images.unsplash.com/photo-1519074069444-1ba4fff66d16?q=80&w=1974&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D"
          ...
          <div className="hidden lg:relative lg:block lg:p-12">
            ...
            <h2 className="mt-6 text-2xl font-bold text-white sm:text-3xl md:text-4xl">
              Welcome to Lords Hoard
            </h2>

            <p className="mt-4 leading-relaxed text-white/90">
              Register to get your own vault to store your hoard.
            </p>
          </div>
        </section>
